...
1. ***POST*** `/balances/deposit/:userId` - Deposits money into the balance of a client, a client can't deposit
...
- Requirements for contract status
- Restrict access to admin methods - Add userRole to the Profile (or create new User entity) and check role